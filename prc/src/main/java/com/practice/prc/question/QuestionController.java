...
import com.practice.prc.answer.AnswerForm;
...
public class QuestionController {
    ...
    public String QuestionList(Model model, @RequestParam(value="page", defaultValue="0") int page,
        ...
        Page<QuestionEntity> paging = this.questionService.getQuestionList(page, kw);
    ...
    public String QuestionCreate(@Valid QuestionForm questionForm, BindingResult bindingResult, Principal principal){
        ...
        this.questionService.saveQuestion(questionForm.getSubject(), questionForm.getContent(), siteUser);
